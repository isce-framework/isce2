...
def main(iargs=None):
    ...
    CAPELLA_str = 'CAPELLA*SLC*.tif'     # Capella SLC tiff files
    CAPELLA_str2 = 'CAPELLA*_extended.json'  # Capella extended metadata files

    # combine together
    sensor_str_list = (ENV_str,ALOS1_str,CSK_str,CSK_str2,RSAT2_str,RSAT2_str2,TSX_TDX_str,TSX_TDX_str2,CAPELLA_str,CAPELLA_str2)
    sensor_list = ('Envisat','ALOS1','CSK','CSK','RSAT2','RSAT2','TSX/TDX','TSX/TDX','Capella','Capella')
    sensor_unpackcommand = ('TODO','TODO','TODO','TODO','prepSlcRSAT2.py','prepSlcRSAT2.py','TODO','TODO','prepSlcCapella.py','prepSlcCapella.py')
