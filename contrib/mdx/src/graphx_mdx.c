...
/* Local functions */
static void  Button_quit(Widget w, Pixmap free, XmAnyCallbackStruct *data);
...
/* For:  file window ***********************************************************************/
char ident[]="     Graphx v80.0      April 30, 2014                 ";
...
void closeCallBack (Widget widgy, XtPointer client_info, XtPointer call_info);
// void closeCallBack ();
void okCallBack (Widget widgy, XtPointer client_info, XmFileSelectionBoxCallbackStruct *call_info);
//void okCallBack();
...
/*************************************************************************/
#ifdef SGI
void version_gpx_( char *gpx_version, size_t length )
#endif
#ifdef SUN
void version_gpx_( char *gpx_version, size_t length )
#endif
#ifdef M10
void version_gpx__( char *gpx_version, size_t length )
#endif
#if defined(HP) || defined(_linux)
void version_gpx( char *gpx_version, size_t length )
#endif
{   
    strcpy( gpx_version," 82.0 07-Mar-2025" );
    return;
}
...
#endif
#ifdef SUN
void get_colorrgb_(char *a_color, int i_color[]);
void get_colorrgb_(char *a_color, int i_color[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void plot_data_(int i_d[], int i_w[], int i_num[], float r_x[10000], float r_y[10000]);
void plot_data_(int i_d[], int i_w[], int i_num[], float r_x[10000], float r_y[10000])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void display_img_(int i_d[], int i_w[], int i_x[], int i_y[], int i_width[], int i_height[], int i_bpl[], float r_rdat[], float r_gdat[], float r_bdat[]);
void display_img_(int i_d[], int i_w[], int i_x[], int i_y[], int i_width[], int i_height[], int i_bpl[], float r_rdat[], float r_gdat[], float r_bdat[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void display_label_(int i_d[], int i_w[], char a_string[255], int i_center[]);
void display_label_(int i_d[], int i_w[], char a_string[255], int i_center[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void entry_window_(int i_chn[1], char a_label[3360], char a_data[3360]);
void entry_window_(int i_chn[1], char a_label[3360], char a_data[3360])
#endif
#ifdef M10
...

{
    ...
    int nnn;
    Arg args[10];
    void          print_result(Widget textwin, char *label);
    void          ewManager(Widget textwin, XtPointer client_info, XtPointer call_info);
//    void          ewdsp_reset();
    void          ewdsp_reset(Widget w, XtPointer client_info);
    XtPointer     XtPtmp;
...
/*      XtSetArg(args[n], XmNdepth,   visualList[0].depth); n++;
	...
	main_windowew[i_chn[0]] = XtCreateManagedWidget("main", 
	   		    ...
	   		    args, n);
        memset( (void *)&XtPtmp, 0, sizeof( XtPointer ) ); memcpy( (void *)&XtPtmp, (void *)i_chn, 4 );
        XtAddCallback(main_windowew[i_chn[0]], XmNdestroyCallback, (void *)&ewdsp_reset, XtPtmp );
...
/*       printf("num of %d = %d\n",i,num); */
	   ...
	   if (i_db > 9-1) printf("a_labels[%d]  %lu  %s\n",i, (unsigned long) &a_labels[i],a_labels[i]);
...
/*           XtAddCallback(textwin, XmNactivateCallback,print_result, (XtPointer)a_lll);   */
 	   i_flag=(i_chn[0]*10000)+((i)*100)+0;
           ...
           memset( (void *)&XtPtmp, 0, sizeof( XtPointer ) ); memcpy( (void *)&XtPtmp, (void *)&i_flag, 4 );
           XtAddCallback(textwin, XmNlosingFocusCallback, ewManager, XtPtmp );
           XtAddCallback(textwin, XmNactivateCallback,    ewManager, XtPtmp );

	   
	   if (i_db > 8-1) printf("a_lll = %s %s %d %d %d\n",a_lll,a_lll,*(a_lll+0),*(a_lll+1),*(a_lll+2));

           XtAddCallback(textwin, XmNactivateCallback,
              (void *) &(XmProcessTraversal), (XtPointer)XmTRAVERSE_NEXT_TAB_GROUP);
...
/*             menu_item[j] = XtVaCreateManagedWidget(a_smenu[j],xmPushButtonGadgetClass,pd_menu,NULL); */
             ...
             memset( (void *)&XtPtmp, 0, sizeof( XtPointer ) ); memcpy( (void *)&XtPtmp, (void *)&i_flag, 4 );
             XtAddCallback(menu_item[j],XmNactivateCallback, ewManager, XtPtmp );
...
void print_result(Widget textwin, char *label)       /* To debug entry window  */
/* Widget textwin;
char  *label; */
{
...
/*    char *value = XmTextFieldGetString(textwin); */
    ...
    XEvent client_event;
        ...
        /* i_data = (int) client_info; NO ! */
        memcpy( (void *)&i_data, (void *) &client_info, 4 ); 
...
#endif
#ifdef SUN
void get_message_(int i_msg[1], char a_msg[160]);
void get_message_(int i_msg[1], char a_msg[160])
#endif
#ifdef M10
...
XtPointer    client_info; */
{
    ...
    /* idata = (int) client_info;  NO ! */
    memcpy( (void *)&idata, (void *) &client_info, 4 );
...
/*************************************************************************/
void MenuManager (Widget widgy, XtPointer client_info, XtPointer call_info) 
// Widget		widgy;		/*  widget id		*/
// XtPointer		client_info;	/*  data from application   */
// XtPointer		call_info;	/*  data from widget class  */
{
...
/*************************************************************************/
void ButtonManager (Widget widgy, XtPointer client_info, XtPointer call_info) 
// Widget		widgy;		/*  widget id		*/
// XtPointer		client_info;	/*  data from application   */
// XtPointer		call_info;	/*  data from widget class  */
{
   ...
   unsigned int  width, height, bwr, dr;
        ...
        /* i_g = (int) client_info; NO ! */
        memcpy( (void *)&i_g, (void *) &client_info, 4 ); 
...
#endif
#ifdef SUN
void gx_getfile_(char a_file[120], int i_inflag[0]);
void gx_getfile_(char a_file[120], int i_inflag[0])
#endif
#ifdef M10
...
#endif
#if defined(HP) || defined(_linux)
void gx_getfile(a_file,i_inflag)
    char a_file[120];
    int i_inflag[0];
#endif
...
/*      gftop = XtAppCreateShell(NULL,"appClass",
    ...
    memset( (void *)&XtPtmp, 0, sizeof( XtPointer ) ); memcpy( (void *)&XtPtmp, (void *)&i_flag, 4 );
    XtAddCallback (fsbox, XmNokCallback, (void *)&okCallBack, XtPtmp );  /* PS Edit added (void *)& */
...
void
okCallBack (Widget widgy, XtPointer client_info, XmFileSelectionBoxCallbackStruct *call_info)
/*     Widget                widgy;
    XtPointer               client_info;
...
#endif
#ifdef SUN
void get_wininfo_(int i_d[], int i_w[], int i_vx[], int i_vy[], int i_vw[], int i_vh[], int i_cw[], int i_ch[] , int i_widget[]);
void get_wininfo_(int i_d[], int i_w[], int i_vx[], int i_vy[], int i_vw[], int i_vh[], int i_cw[], int i_ch[] , int i_widget[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void move_scroll_(int i_d[], int i_w[], int i_x[], int i_y[]);
void move_scroll_(int i_d[], int i_w[], int i_x[], int i_y[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void resize_win_(int i_d[], int i_w[], int i_x[], int i_y[]);
void resize_win_(int i_d[], int i_w[], int i_x[], int i_y[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void set_button_shadow_(int i_d[], int i_w[], int i_shadow[], int i_debug[]);
void set_button_shadow_(int i_d[], int i_w[], int i_shadow[], int i_debug[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void move_win_(int i_d[], int i_w[], int i_x[], int i_y[]);
void move_win_(int i_d[], int i_w[], int i_x[], int i_y[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void getevent_(int i_flg[], int i_event[10]);
void getevent_(int i_flg[], int i_event[10])
#endif
#ifdef M10
void getevent_(i_flg,i_event)
...
/*              if (i_event[1] == 0) {
            ...
            case MotionNotify:
              ...
              break;
            case ClientMessage:
              if (i_db > 9-1) printf("report=ClientMessage %ld %ld %ld\n",report.xclient.data.l[0], 
...
#endif
#ifdef SUN
void clear_win_(int i_d[], int i_w[]);
void clear_win_(int i_d[], int i_w[])
#endif
#ifdef M10
...
#endif
#ifdef SUN
void get_dialog_(char a_msg[], char a_rsp[]);
void get_dialog_(char a_msg[], char a_rsp[])
#endif
#ifdef M10
...
//                  if (buffer == NULL) printf("Unmapped function key\n");  /* PS Edit... apparently this is always true */
                  if (0==0) printf("Unmapped function key\n");  /* PS Edit..  just making it get rid of warning from above */
...
#endif
#ifdef SUN
int init_gx_(int i_wxi[], int i_typ[], char a_labl[], int i_wxs[], int i_wys[], int i_frx[], int i_fry[], char a_menu[], char a_lcolor[], int i_cin[], int i_din[]);
int init_gx_(int i_wxi[], int i_typ[], char a_labl[], int i_wxs[], int i_wys[], int i_frx[], int i_fry[], char a_menu[], char a_lcolor[], int i_cin[], int i_din[])
#endif
#ifdef M10
	...
	if (*i_bswap == 1) {
	  ...
	  if (i_db > 4-1) printf("i_bswap=%d\n",*i_bswap);
        ...
        if (i_db > 4-1) {
          ...
          printf(" \n");
          if (i_db > 2-1) printf("Using visual ID=%lu  size=%d  bpc=%d depth=%d type=%s\n", 
...
*/        
      ...
      if (i_db > 5-1) printf("dgx = %lu \n", (unsigned long) dgx); 
      if (i_db > 5-1) printf("root = %lu\n",root); 
...
/*                XtSetArg(args[n], XmNdepth,   visualList[0].depth); n++;
	        ...
	        XtManageChild (button);
                memset( (void *)&XtPtmp, 0, sizeof( XtPointer ) ); memcpy( (void *)&XtPtmp, (void *)&i_flag, 4 );
	        XtAddCallback (button, XmNactivateCallback, MenuManager, XtPtmp );
...
*/
	      ...
	      a_llll[i_g]=XmStringCreateSimple(a_lbl);
              ...
              memset( (void *)&XtPtmp, 0, sizeof( XtPointer ) ); memcpy( (void *)&XtPtmp, (void *)&i_flag, 4 );
	      XtAddCallback(draw[i_g],XmNactivateCallback,ButtonManager, XtPtmp );
	      XtAddCallback(draw[i_g],XmNexposeCallback,  ButtonManager, XtPtmp );
	      XtAddCallback(draw[i_g],XmNresizeCallback,  ButtonManager, XtPtmp );
...
/*    if (i_db > 5-1) printf("setting window areas\n"); 
    ...
    if (i_db > 6-1) printf("menu wgx= %lu %d\n",wgx[i_g],i_g); 

    if (i_db > 6-1) printf("wgx= %lu %d\n",wgx[i_g],i_g); 
...
/*    gc = XCreateGC(dgx,top[i_d],0,NULL); */
    ...
    if (i_cnt[0]==0) {   /* edited by PS to make this a logical instead of an assignment */
    ...
    if (i_db > 7-1) printf("wgx = %lu %lu %lu %lu %lu %lu %lu\n",wgx[1],wgx[2],wgx[3],wgx[4],wgx[5],wgx[6],wgx[7]);
    return(i_d);
...
#endif
#ifdef SUN
int initdk_(int *i_flag, char *a_filename);
int initdk_(int *i_flag, char *a_filename)
#endif
#ifdef M10
int initdk_(i_flag, a_filename)
...
#endif
#ifdef SUN
int iowrit_(int *i_chan, char *b_buff, int *bytes);
int iowrit_(int *i_chan, char *b_buff, int *bytes)
#endif
#ifdef M10
int iowrit_(i_chan, b_buff, bytes)
...
#endif
#ifdef SUN
int ioread_(int *i_chan, char *b_buff, int *bytes);
int ioread_(int *i_chan, char *b_buff, int *bytes)
#endif
#ifdef M10
int ioread_(i_chan, b_buff, bytes)
...
#endif
#ifdef SUN
int ioseek_(int *i_chan, int *lbyte, int *i_flag);
int ioseek_(int *i_chan, int *lbyte, int *i_flag)
#endif
#ifdef M10
int ioseek_(i_chan, lbyte,i_flag)
...
#endif
#ifdef SUN
long long ioseek64_(int *i_chan, long *lbyte, int *i_flag);
long long ioseek64_(int *i_chan, long *lbyte, int *i_flag)
#endif
#ifdef M10
long long ioseek64_(i_chan, lbyte,i_flag)
