...
#ifndef estambmoduleFortTrans_h
#define estambmoduleFortTrans_h
                        ...
                        #define setMinAmb_f setminamb_
                        #define setMaxAmb_f setmaxamb_
                        #define allocate_entropy_f allocate_entropy_
                        #define deallocate_entropy_f deallocate_entropy_
                        #define getEntropy_f getentropy_
                #else
