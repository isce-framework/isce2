...
int	k, nval, nd;
	...
	if (verbose) fprintf(stderr," time %lf nd %d\n",time,nd);
	...
	if (verbose) fprintf(stderr, "C pt %lf px %lf pvx %lf time %lf x %lf ir %d \n",*pt,p[0],pv[0],time,*x,*ir);
	...
	if (verbose) fprintf(stderr, "C pt %lf py %lf pvy %lf time %lf y %lf ir %d \n",*pt,p[0],pv[0],time,*y,*ir);
	...
	if (verbose) fprintf(stderr, "C pt %lf pz %lf pvz %lf time %lf z %lf ir %d \n",*pt,p[0],pv[0],time,*z,*ir);
