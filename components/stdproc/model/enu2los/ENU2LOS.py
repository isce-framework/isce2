...
from stdproc.model.enu2los import enu2los

class ENU2LOS(Component):
    '''
    Class for dealing with projecting data to LOS.
    Takes a 3-channel ENU file in meters and projects it to LOS in radians.
    '''

    def enu2los(self, modelImage = None, latImage=None, lonImage=None, losImage=None, outImage=None):
        '''
        The driver.
        '''
        ...
        enu2los.enu2los(self._ptr, modelAccessor,latAccessor,lonAccessor,losAccessor,outAccessor)
    ...
    def setDefaults(self):
        ...
        ####To return LOS displacement in meters
    ...
    def setState(self):
        ...
        '''
        enu2los.setDims(self._ptr, self._width, self._numberLines)
        enu2los.setGeoDims(self._ptr, self._geoWidth, self._geoNumberLines)
        enu2los.setWavelength(self._ptr, self._wavelength)
        enu2los.setScaleFactor(self._ptr, self._scaleFactor)
        enu2los.setLatitudeInfo(self._ptr, self._startLatitude, self._deltaLatitude)
        enu2los.setLongitudeInfo(self._ptr, self._startLongitude, self._deltaLongitude)
        return
    ...
    def __init__(self):
        ...
        self._ptr = enu2los.createENU2LOS()
    ...
    def __del__(self):
        ...
        Destructor.
        '''
        enu2los.destroyENU2LOS(self._ptr)
        pass
...
#    data[:,2::3] = 1.0
    ...
    model.enu2los(modelImage=objModel, latImage=objLat, lonImage=objLon, losImage=objLos, outImage=objOut)
