...
#ifndef geo2rdrmodule_h
#define geo2rdrmodule_h

#include <Python.h>
#include <stdint.h>
#include "geo2rdrmoduleFortTrans.h"
...
extern "C"
{
    ...
    void geo2rdr_f(uint64_t *, uint64_t *, uint64_t *, uint64_t *, 
        uint64_t*, uint64_t*, uint64_t*);
    PyObject * geo2rdr_C(PyObject *, PyObject *);
...
static PyMethodDef geo2rdr_methods[] =
{
    {"geo2rdr_Py", geo2rdr_C, METH_VARARGS, " "},
