...
#ifndef bistaticgeo2rdrmoduleFortTrans_h
#define bistaticgeo2rdrmoduleFortTrans_h

        #if defined(NEEDS_F77_TRANSLATION)

                #if defined(F77EXTERNS_LOWERCASE_TRAILINGBAR)
                        #define bistaticgeo2rdr_f bistaticgeo2rdr_
                        ...
                        #define setActiveRangeFirstSample_f setactiverangefirstsample_
                        #define setPassiveRangeFirstSample_f setpassiverangefirstsample_
                        #define setRangePixelSpacing_f setrangepixelspacing_
                        #define setActiveOrbit_f setactiveorbit_
                        #define setPassiveOrbit_f setpassiveorbit_
...
#endif //bistaticgeo2rdrmoduleFortTrans_h
