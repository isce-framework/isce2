...
class COSMO_SkyMed_G2_SLC(Sensor):
    """
    ...
    def __init__(self,family='',name=''):
        super(COSMO_SkyMed_G2_SLC,self).__init__(family if family else  self.__class__.family, name=name)
        self.frame = Frame()
    ...
    def _populateInstrument(self, file):
        ...
        incangle = 0.5*(file.attrs['Far Incidence Angle'] +
                 file.attrs['Near Incidence Angle'])
    ...
    def extractImage(self):
        ...
        extract_csk.extract_csg_slc(inFile_c, outFile_c)
