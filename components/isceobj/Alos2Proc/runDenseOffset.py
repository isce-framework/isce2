...
def runDenseOffsetCPU(self):
    ...
    print('dense offset estimation window height: %d' % (self.offsetWindowHeight))
    print('dense offset search window width: %d' % (self.offsetSearchWindowWidth))
    print('dense offset search window height: %d' % (self.offsetSearchWindowHeight))
    print('dense offset skip width: %d' % (self.offsetSkipWidth))
    print('dense offset skip height: %d' % (self.offsetSkipHeight))
