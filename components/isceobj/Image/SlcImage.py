...
class SlcImage(Image):
    ...
    def updateParameters(self):
        self.extendParameterList(Image,SlcImage)
        super(SlcImage,self).updateParameters()
    ...
    def __init__(self,family='',name=''):
        ...
        super(SlcImage, self).__init__(family if family else  self.__class__.family, name=name)

        self.initOptionalAndMandatoryLists()
        self.addDescription('Single look complex image.')  
            

        self.logger = logging.getLogger('isce.Image.SlcImage')
