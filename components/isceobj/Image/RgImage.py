...
##
# This class allows the creation of a RgImage object. The parameters that need to be set are
#\verbatim
...
#\endverbatim
#Since the RgImage class inherits the Image.Image, the methods of initialization described in the Component package can be used.
...
class RgImage(Image):
    ...
    def updateParameters(self):
        self.extendParameterList(Image,RgImage)
        super(RgImage,self).updateParameters()
    ...
    def __init__(self,family='',name=''):
        ...
        super(RgImage, self).__init__(family if family else  self.__class__.family, name=name)  

        self.initOptionalAndMandatoryLists()

        self.logger = logging.getLogger('isce.Image.RgImageBase')
