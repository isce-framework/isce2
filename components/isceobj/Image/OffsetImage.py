...
##
# This class allows the creation of a OffsetImage object. The parameters that need to be set are
#\verbatim
...
#\endverbatim
#Since the OffsetImage class inherits the Image.Image, the methods of initialization described in the Component package can be used.
...
class OffsetImage(Image):
    ...
    def updateParameters(self):
        self.extendParameterList(Image,OffsetImage)
        super(OffsetImage,self).updateParameters()
    ...
    def __init__(self,family='',name=''):
        ...
        super(OffsetImage, self).__init__(family if family else  self.__class__.family, name=name)

        self.initOptionalAndMandatoryLists()

        self.logger = logging.getLogger('isce.Image.OffsetImage')
    ...
    def __setstate__(self,d):
        ...
        self.logger = logging.getLogger('isce.Image.OffsetImageBase')
        return
